...
/**
 * elf_magic - prints the magic number of an ELF file
...
/**
 * elf_class - prints the class (32-bit or 64-bit) of an ELF file
 * @buffer: the ELF header
 *
...
/**
 * elf_osabi - prints the OS and ABI of an ELF file
 * @buffer: the ELF header
 */
...
/**
 * elf_abivers - prints the ABI version of an ELF file
 * @buffer: the ELF header
 */
